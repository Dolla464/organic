...
<head>
    ...
    <!-- App Routes for JS (Good Practice!) -->
    <meta name="routes"
        content="<?php echo e(json_encode([
            'cart_add' => route('cart.add'),
            'cart_remove' => route('cart.remove'),
            'cart_update' => route('cart.update'),
        ])); ?>">

    
    <meta name="author" content="Adel Abdel Monaem">
...
<body>
        ...
        <div class="offcanvas-body">
            <div class="order-md-last">
                <h4 class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <span id="cart-count-badge" class="badge bg-primary rounded-pill">
                ...
                <ul id="cart-list" class="list-group mb-3">
                    <?php $__empty_1 = true; $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <li class="list-group-item d-flex justify-content-between lh-sm"
                            data-item-id="<?php echo e($id); ?>">
                            <div class="d-flex">
                                <img src="<?php echo e(asset('img/products/' . $item['image'])); ?>" alt="<?php echo e($item['name']); ?>"
                                    class="me-3"
                                    style="width: 60px; height: 60px; object-fit: cover; border-radius: 5px;"
                                    onerror="this.src='<?php echo e(asset('img/default.png')); ?>'; this.onerror=null;">
                                <div>
                                    <h6 class="my-0"><?php echo e($item['name']); ?></h6>
                                    <div class="input-group input-group-sm mt-2" style="width: 100px;">
                                        <button class="btn btn-outline-secondary change-quantity-btn" type="button"
                            ...
                            <div class="d-flex flex-column align-items-end">
                                <span class="text-muted mb-2 item-total-price">
                                    $<?php echo e(number_format($item['price'] * $item['quantity'], 2)); ?>

                                </span>
                                <button class="btn btn-sm btn-outline-danger remove-from-cart-btn"
                                    data-id="<?php echo e($id); ?>" title="Remove item">×</button>
                            </div>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <li class="list-group-item" id="cart-empty-message">Your cart is empty.</li>
                    <?php endif; ?>
                </ul>
                <!-- End of ul#cart-list -->

                <!-- 3. WRAP THE TOTAL IN A DIV WITH AN ID -->
                <div id="cart-total-container">
                    <?php if(count($cart) > 0): ?>
                        <div class="list-group-item d-flex justify-content-between">
                            <span>Total (USD)</span>
                            <strong id="cart-grand-total">$<?php echo e(number_format($total, 2)); ?></strong>
                        </div>
                    <?php endif; ?>
                </div>

                <a href="#" id="checkout-button"
                    class="w-100 btn btn-primary btn-lg mt-3 <?php echo e(count($cart) == 0 ? 'disabled' : ''); ?>">Continue to
                    checkout</a>
            </div>
        </div>
    </div>
            ...
            <div class="row py-3 border-bottom">
                ...
                <div
                    ...
                    <div class="d-flex align-items-center my-3 my-sm-0">
                        <a href="/">
                            <img src="<?php echo e(asset('images/logo.svg')); ?>" alt="logo" class="img-fluid">
                        </a>
                    </div>
                    ...
                    <ul
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="pagesDropdown">
                                <li><a href="<?php echo e(route('categoryuser')); ?>" class="dropdown-item">Categories</a></li>
                                <li><a href="<?php echo e(route('shoppinguser')); ?>" class="dropdown-item">Shopping</a></li>
                ...
                <div
                    class="col-sm-8 col-lg-2 d-flex  align-items-center justify-content-center justify-content-sm-end">
                    <ul class="d-flex justify-content-end list-unstyled m-2">
                            ...
                            <div class="position-relative">
                                <a href="#" class="p-2 mx-1" data-bs-toggle="offcanvas"
                                    ...
                                    <span id="cart-icon-badge"
                                        class="position-absolute top-20 start-75 translate-middle badge rounded-pill bg-danger"
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer-menu">
                        <img src="<?php echo e(asset('images/logo.svg')); ?>" width="240" height="70" alt="logo">
        ...
        <div class="container-lg">
            <div class="row">
                ...
                <div class="col-md-6 credit-link text-start text-md-end">
                    <p>Designed by <a href="https://templatesjungle.com/">Adel Abdel Monaem</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- *** SCRIPT LOADING SECTION - CLEANED UP *** -->
    <!-- External libraries that are not bundled in app.js can be loaded here. -->
    ...
    <!-- This is where page-specific scripts will be injected LAST -->
    <?php echo $__env->yieldPushContent('scripts'); ?>

</body>

</html>
<?php /**PATH D:\ADEL\Web Developing\T-square course\laravel projects\organic\resources\views/layouts/appuser.blade.php ENDPATH**/ ?>